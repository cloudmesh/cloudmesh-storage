...
# This works, but as interim only: def __init__(self, service=None):
# Created from "quickstart2.py"
    ...
    def __init__(self, service=None, config="~/.cloudmesh/cloudmesh.yaml"):
        ...
        creds = None
        # Temporarily change directory to credential_json_path specified in cloudmesh.yaml
